...
public class HiveServiceImpl implements HiveService {
    ...
    public EdmTaskResult optHiveFetchEdmTaskResult(EdmConditionOfOrder edmConditionOfOrder) {
        ...
        String tempTableName = "temp_qunfa_tishu_" + year_month_day + "_" + random.nextInt(1000);
    ...
    private String overwriteEnableTableData(String tempTableName, String dimension) {
        ...
        sb.append("insert overwrite table dm_kf_usable_users_dimension_current_month partition(dimension='" + dimension + "') " +
                "select " +
                ...
                "from dm_kf_usable_users_dimension_current_month " +
                "where 1=1 " +
    ...
    private String insertToHistoryTable(String tempTableName, String yearMonth, String yearMonthDay, Integer typeValue, String datacode) {
        StringBuilder sb = new StringBuilder();
        sb.append("insert into DW_USER_SENDRECORDS_NEW partition(month='" + yearMonth + "',day='" + yearMonthDay + "') " +
                "select " +
                "a.user_device, " +
                "'" + typeValue + "' as type, " +
                "a.mailroot, " +
    ...
    private String createHistoryTableIfNotExists() {
        StringBuilder sb = new StringBuilder();
        sb.append("create table if not exists DW_USER_SENDRECORDS_NEW " +
                "( " +
                "user_device             string, " +
                "type                    string, " +
                "mailroot                string, " +
